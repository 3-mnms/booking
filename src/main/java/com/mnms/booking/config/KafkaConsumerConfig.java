...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, UserEventListener.UserEventDTO> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UserEventListener.UserEventDTO> kafkaListenerContainerFactory() {


        ConcurrentKafkaListenerContainerFactory<String, UserEventListener.UserEventDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
